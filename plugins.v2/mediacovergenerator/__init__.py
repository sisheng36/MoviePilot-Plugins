...
class MediaCoverGenerator(_PluginBase):
    ...
    # 插件作者
    plugin_author = "justzerock&zoffyultraman&sisheng36"
    # 作者主页
    ...
    def __update_config(self):
        ...
        self.update_config({
            ...
            "zh_font_path": str(self._zh_font_path) if self._zh_font_path else "",
            "en_font_path": str(self._en_font_path) if self._en_font_path else "",
